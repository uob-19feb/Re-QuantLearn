(function(){
    ...
    var data = {
        quizContent: [
            ...
            {
                question: "who introduced quantum computing idea",
                answer1: "Richar Fyeman",
                answer2: "Niel armstong",
                answer3: "albert Eienstien",
                correctAnswer: 1
            },
            {
                question: "What use of qunatum copmuter?",
                answer1: "cryptography",
                answer2: "weather forecasting",
                answer3: "gamming",
                correctAnswer: 3
            },
            {
                question: "why quantum computer is used ?:",
                answer1: "i don't now",
                answer2: "for fun",
                answer3: "calculation",
                correctAnswer: 1
            ...
            {
                question: "what is quantum gate?",
                answer1: "similar to logic gate by in quantum sense",
                answer2: "physical gate",
                answer3: "no idea",
                correctAnswer: 2
            }
        ],
    ...
    var display = {
        ...
        mainPage: function() {
            var newEl = '<div class="quest-number"><p id="questNumber"></p></div><h1 id="questionDisplay" class="h3"></h1>';
                newEl += '<ul class="quizSizing"><li><label><input type="radio" name="answers" id="input1" value="1"><span class="outer"><span class="inner"></span></span><div id="answerDisplay1"></div></label></li>';
        ...
        resultPage: function() {
            this.getApp.innerHTML = '<h1 class="h3">You answered ' + data.points + ' question(s) correctly </h1>';
